classdef StrapdownRegressionLayer < nnet.layer.RegressionLayer
    ...
    methods
        function layer = StrapdownRegressionLayer(name)
            % Set layer name.
            layer.Name = name;
        ...
        function loss = forwardLoss(layer,Y, T)
            ...
            SSE = sum((att-T).^2,3); %L2-attitude norm for each trajectory
