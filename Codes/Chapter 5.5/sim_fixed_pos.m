function  simulation = sim_fixed_pos(BW, ~) 
...
load sim_static_pos_60sec_stops.mat
t=OBS.time;
...
simulation.gyro_x_noisy     = wx_noisy;
simulation.gyro_y_noisy     = wy_noisy;
simulation.gyro_z_noisy     = wz_noisy;

simulation.gyro_x_ref       = OBS.omega_ib_b_GT(:,1); 
simulation.gyro_y_ref       = OBS.omega_ib_b_GT(:,2); 
simulation.gyro_z_ref       = OBS.omega_ib_b_GT(:,3); 

simulation.bias_gyro        = bias_gyro;
simulation.SF_gyro          = SF_gyro;
simulation.ARW              = ARW;

simulation.psi              = OBS.attitude_GT.psi*pi/180;
simulation.psi_dot          = OBS.attitude_GT.psi_dot;
