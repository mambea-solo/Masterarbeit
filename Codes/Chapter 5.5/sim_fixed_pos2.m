function  simulation2 = sim_fixed_pos2(BW, ~) 
...
simulation2.gyro_x_noisy     = wx_noisy;
simulation2.gyro_y_noisy     = wy_noisy;
simulation2.gyro_z_noisy     = wz_noisy;

simulation2.gyro_x_ref       = OBS.omega_ib_b_GT(:,1); 
simulation2.gyro_y_ref       = OBS.omega_ib_b_GT(:,2); 
simulation2.gyro_z_ref       = OBS.omega_ib_b_GT(:,3); 

simulation2.bias_gyro        = bias_gyro;
simulation2.SF_gyro          = SF_gyro;
simulation2.ARW              = ARW;

simulation2.psi              = OBS.attitude_GT.psi*pi/180;
simulation2.psi_dot          = OBS.attitude_GT.psi_dot;
