function  simulation3 = sim_fixed_pos3(BW, ~) 
...
load const_rotation_position_manyTurns.mat
t=OBS.time;
...
simulation3.gyro_x_noisy     = wx_noisy;
simulation3.gyro_y_noisy     = wy_noisy;
simulation3.gyro_z_noisy     = wz_noisy;

simulation3.gyro_x_ref       = OBS.omega_ib_b_GT(:,1); 
simulation3.gyro_y_ref       = OBS.omega_ib_b_GT(:,2); 
simulation3.gyro_z_ref       = OBS.omega_ib_b_GT(:,3); 

simulation3.bias_gyro        = bias_gyro;
simulation3.SF_gyro          = SF_gyro;
simulation3.ARW              = ARW;

simulation3.psi              = OBS.attitude_GT.psi*pi/180;
simulation3.psi_dot          = OBS.attitude_GT.psi_dot;
